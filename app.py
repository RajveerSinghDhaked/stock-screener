...
st_autorefresh(interval=600, key="auto_refresh")
init_database()
...
<style>
    ...
    div[data-testid="stMetricLabel"] { font-size: 0.75rem !important; color: #888; }
    .signal-badge {
        display: inline-block; padding: 3px 10px; border-radius: 15px;
        font-size: 0.75rem; font-weight: 600; margin: 2px;
    }
    .buy-badge { background: #00C85315; color: #00C853; border: 1px solid #00C85330; }
    .sell-badge { background: #FF174415; color: #FF1744; border: 1px solid #FF174430; }
    .neutral-badge { background: #FFA72615; color: #FFA726; border: 1px solid #FFA72630; }
    .rec-card {
    ...
    .warn-box {
        background: #FF174410; border-left: 3px solid #FF1744;
    ...
    div[data-baseweb="tab"][aria-selected="true"] {
        background: #16213e; border-bottom-color: transparent;
    }
</style>
...
def rec_box_html(analysis):
    ...
    html += f'<span style="color:#666;font-size:0.8rem;">Confidence {confidence}%</span>'
    html += '</div>'
    if rr and rr.get("valid"):
        html += '<div style="display:flex;gap:24px;font-size:0.9rem;color:#AAA;margin-top:8px;">'
